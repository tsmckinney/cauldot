...
**Cauldot Engine is a fork of MIT-licensed [Godot Engine](https://godotengine.org), which is
a feature-packed, cross-platform game engine to create 2D and 3D games from a 
unified interface.** It provides a comprehensive set of [common tools](https://godotengine.org/features), so that
...
Both Godot and Cauldot are completely free and open source under the very permissive 
[MIT license](https://godotengine.org/license).
No strings attached, no royalties, nothing. The users' games are theirs, down
to the last line of engine code. Development of this engine and the original are both fully independent and
community-driven, empowering users to help shape their engine to match their
expectations. The original engine is supported by the [Godot Foundation](https://godot.foundation/)
not-for-profit.
...
of abuse. So, I wanted to make Cauldot a safe, community-driven space. ( ;) ) 
Let's encourage respect and kindness with this fork instead of the toxicity previously 
directed at Godot.
...
Official binaries for the Cauldot editor and the export templates can be found
in the Releases page of this repo.

### Compiling from source

[See Godot's official docs](https://docs.godotengine.org/en/latest/contributing/development/compiling)
...
The best way to get in touch with the Godot's developers is to join the
[Godot Contributors Chat](https://chat.godotengine.org).

To get started contributing to the project, see our [contributing guide](CONTRIBUTING.md).
...
is also accessible from the Cauldot editor.

Godot also maintains official demos in their own [GitHub repository](https://github.com/godotengine/godot-demo-projects)
as well as a list of [awesome community resources](https://github.com/godotengine/awesome-godot).

There are also a number of other
[learning resources](https://docs.godotengine.org/en/latest/community/tutorials.html)
provided by the community, such as text and video tutorials, demos, etc.
Consult Godot's [community channels](https://godotengine.org/community)
